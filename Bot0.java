...
public class Bot0 implements BotAPI
{
    ...
    Bot0(PlayerAPI me, OpponentAPI opponent, BoardAPI board, UserInterfaceAPI ui, DictionaryAPI dictionary) {
        ...
        this.command = "";
        this.maxLength = 7;
        this.chosenDicWordForPlacement = new Word(7,7,true, normalFrame.substring(0,3),"");
        //   this.vowelCount = 0;
    }

    private void unchrisIt() {
        String chris = me.getFrameAsString().toLowerCase();
        String antichris = "";
        for (int i = 1; i < 20; i += 3)
            antichris += chris.charAt(i);
        this.normalFrame = antichris;
...
//~~~~~~~~~~~~~~~~~~
    ...
    private Word generateWords(){
      chosenDicWordForPlacement =new Word(7,7,true, this.normalFrame.substring(0,3),"");
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    private String build_command_startPlace(Word chosenDicWordForPlacement) { //local var
    ...
    public String getCommand() {
       ...
       /*     case 1:
                ...
                break;*/
            case 1:
                this.permutations.addAll(this.bruteForce(2));
                command+= "|||   "+this.normalFrame+"     ||| ";
                for(int i =0; i<15; i++)
                command+= permutations.get(i);
                command+=" ";
